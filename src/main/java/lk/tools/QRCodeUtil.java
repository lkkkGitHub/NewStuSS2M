...
public class QRCodeUtil {
    ...
    private static BufferedImage createImage(
            String content, String logoPath, boolean needCompress)
            throws Exception {
    ...
    public static String getWeiXinBarcodePath() throws Exception {
        String fPath = "images";
        String fName = "qrcode";
        String barcodeFilePath = ServletActionContext.getServletContext().getRealPath("images");
        File file = new File(barcodeFilePath+"/"+fName+".jpg");
        if(file.exists() && !file.isDirectory()){
            //文件已存在
            return fPath+"/"+fName+".jpg";
        }
        ...
        //含Logo，指定二维码图片名
        String logoPath = ServletActionContext.getServletContext().getRealPath("images/lo.png");
        QRCodeUtil.encode(text, logoPath,barcodeFilePath,fName, true);
        return fPath+"/"+fName+".jpg";
    }
